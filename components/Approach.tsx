    ...
    <section className="w-full py-20">
        ...
        <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
            <Card 
                ...
                description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci placeat dolor sit hic possimus beatae sequi exercitationem qui quo? Quae quia est quas, distinctio sunt illo quo amet sequi corporis!" 
            >
                <CanvasRevealEffect
                    animationSpeed={5.1}
